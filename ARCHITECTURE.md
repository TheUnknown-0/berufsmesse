...
| Admin | `/{school}/admin/` + `dashboard`, `aussteller`, `raeume`, `kapazitaeten`, `anmeldungen`, `benutzer`, `berechtigungen`, `qr-codes`, `anwesenheit`, `anwesenheit-live`, `anwesenheit-bericht`, `aufsicht`, `druckzentrale`, `ausstattung`, `ankuendigungen`, `feedback`, `einstellungen`, `audit-log` |
